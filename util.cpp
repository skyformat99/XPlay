//声明：此文件中的所有代码均摘录自“https://github.com/u8sand/Baka-MPlayer/blob/master/src/util.cpp”和“https://github.com/u8sand/Baka-MPlayer/blob/master/src/platform/win.cpp”，做了部分改动
...
{
    return QString::fromLatin1("Lucida Console");
}
